...
namespace Correspondence.Networking
{
	internal class AsynchronousServerProxy
	{
        ...
        private Observable<SendState> _sendState = new Observable<SendState>();
        private Observable<ReceiveState> _receiveState = new Observable<ReceiveState>();
        private Observable<Exception> _lastSendException = new Observable<Exception>();
        private Observable<Exception> _lastReceiveException = new Observable<Exception>();
