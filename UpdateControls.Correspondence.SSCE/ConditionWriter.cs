...
{
    internal class ConditionWriter : IConditionVisitor
    {
        private SSCEStorageStrategy _storageStrategy;
        ...
        public ConditionWriter(SSCEStorageStrategy storageStrategy, Session session, StringBuilder conditions, List<int> roleIds, int depth, string branchAlias)
        {
