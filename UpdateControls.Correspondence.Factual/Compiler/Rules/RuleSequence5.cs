...
{
    public class RuleSequence5<T1, T2, T3, T4, T5, T> : RuleSequence<T>
    {
        ...
        public RuleSequence5(Rule<T1> rule1, Rule<T2> rule2, string error2, Rule<T3> rule3, string error3, Rule<T4> rule4, string error4, Rule<T5> rule5, string error5, Function reduce)
        {
            _rule1 = rule1;
            _rule2 = rule2;
            _error2 = error2;
