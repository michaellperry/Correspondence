...
namespace UpdateControls.Correspondence.UnitTest.Model
{
    ...
    public partial class Tournament : CorrespondenceFact
    {
		...
		internal class CorrespondenceFactFactory : ICorrespondenceFactFactory
		{
            ...
            public CorrespondenceFact GetUnloadedInstance()
            {
                return Tournament.GetUnloadedInstance();
            }

            public CorrespondenceFact GetNullInstance()
            {
                return Tournament.GetNullInstance();
            }
		}
        ...
        {
            return new Tournament((FactMemento)null) { IsLoaded = false };
        }

        public static Tournament GetNullInstance()
        {
            return new Tournament((FactMemento)null) { IsNull = true };
        }
